          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                <p style={{marginBottom: '20px'}} className="text-center text-base font-medium text-body-color">
                ...
                <p style={{marginTop: '20px'}} className="text-center text-base font-medium text-body-color">
                  This information is confidential and available only to
                  investors in certain funds, and certain clients, of the
                  COBRA.UNIT group.
                </p>
              </div>
            </div>
